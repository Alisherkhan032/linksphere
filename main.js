...
const RESUME_URL = "http://tiny.cc/Alisherkhan032";
const LINKEDIN_URL = "https://linkedin.com/in/Alisherkhan032";
const GITHUB_URL = "https://github.com/Alisherkhan032";

// Command related constants
const ALL_SUPPORTED_CMDS = "help, resume, bio, linkedin, github, contact, date. But don't try to gain access by running commands like sudo";
const CMDS_COMING_SOON = "These commands will come soon: projects, clear, home"


// club commands based on results
const SPECIAL_CMDS = ['ali', 'projects'];
const DEBUG_CMDS = ['h'];
...
const CONTACT_RESULT = "Ali is reachable at: alisherkhan032@gmail.com. You maybe be looking for the following commands: linkedin, github, about";

const LINKEDIN_RESULT = "Connect with Ali on LinkedIn here: " + LINKEDIN_URL + ". Hold on, opening in a new tab. Please check if the pop-ups are not blocked";

const GITHUB_RESULT = "Most of the Ali's contribution goes to github enterprise, hence they may not be visible in his public profile. Here is Ali's github url: " + GITHUB_URL + ". Hold on, opening in a new tab. Please check if the pop-ups are not blocked";
...
function getResultText(cmd) {
    ...
    switch (true) {
        ...
        case BIO_CMDS.includes(cmd):
            resultText += "Here's a quick info about Ali. " + BIO_RESULT;
            break;
